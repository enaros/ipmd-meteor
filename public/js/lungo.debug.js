...
(function() {
  Lungo.Aside = (function(lng) {
    var ANIMATION_DURATION, C, CUSTOM_KF_HIDE, CUSTOM_KF_SHOW, animationEnd, draggable, hide, show, toggle, _alreadyOpen, _asideStylesheet, _callback, _createCustomAnimation, _customAsideAnimation, _kfPrefix;
    C = lng.Constants;
    _callback = void 0;
    ...
    lng.ready(function() {
      var isMoz, _ref;
      isMoz = ((_ref = lng.Core.environment().browser.match(/mozilla|firefox/gi)) != null ? _ref.length : void 0) > 0;
      return _kfPrefix = isMoz ? '' : '-webkit-';
    });
    /*
    ...
    */
    ...
    show = function(aside_id, fixed, fromX) {
      var animationValue, aside, aside_section, aside_transition, child, childs, _i, _len, _ref;
      if (fixed == null) {
        fixed = false;
      }
      if (fromX == null) {
          ...
          if (!fixed) {
            ...
            if (lng.DEVICE === C.DEVICE.PHONE) {
              ...
              if (fromX !== -1) {
                ...
                return lng.Element.Cache.section.style("" + _kfPrefix + "animation", animationValue);
              } else {
    ...
    */
    ...
    hide = function(callback, fromX) {
      var animationValue, aside_transition, _ref;
      if (fromX == null) {
        fromX = null;
      }
      if (lng.Element.Cache.aside || fromX) {
        _callback = callback;
        aside_transition = ((_ref = lng.Element.Cache.aside) != null ? _ref.data(C.TRANSITION.ATTR) : void 0) || "left";
        if (lng.DEVICE === C.DEVICE.PHONE) {
          if (fromX > 0) {
    ...
    */
    ...
    animationEnd = function(event) {
      var aside_transition, className, section, _ref;
      section = lng.dom(event.target);
      aside_transition = ((_ref = lng.Element.Cache.aside) != null ? _ref.data(C.TRANSITION.ATTR) : void 0) || "left";
      if (section.data("aside-" + aside_transition) === "hide") {
        ...
        if (section.style("" + _kfPrefix + "animation").indexOf(CUSTOM_KF_HIDE) === -1) {
